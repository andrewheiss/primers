...
To make a histogram with ggplot2, add `geom_histogram()` to the [ggplot2 template](https://andrewheiss.shinyapps.io/ath-primers-basics-01-visualization/). For example, the code below plots a histogram of the `carat` variable in the `diamonds` dataset, which comes with ggplot2. 
